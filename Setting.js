...
global.owner = process.env.OWNER_NUMBER  || '237654765115' ;  // ADD YOUR NUMBER WITHOUT +
...
global.mztit = process.env.MZTIT ||"Stark",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  ownername:  process.env.OWNER_NAME  || `EDWARD STARK`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'Edward Stark',      // ADD YOUR STICKER AUTHOR NAME
